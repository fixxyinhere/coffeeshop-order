<x-layouts.admin>
    <div>
        <h2 class="font-heading text-2xl text-coffee-800 mb-6">Tambah Kategori</h2>
        <form action="{{ route('admin.categories.store') }}" method="POST" class="bg-white rounded-xl border border-coffee-100 p-6 shadow-sm max-w-lg">
            @csrf
            <div class="space-y-4">
                <div>
